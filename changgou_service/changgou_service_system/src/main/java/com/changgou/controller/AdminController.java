...
import com.changgou.service.AdminService;
...
import static com.changgou.util.JwtUtil.createJWT;
...
//        Admin admin = adminService.findById(id);
    ...
    public Result login(@RequestBody Admin admin) {
        ...
        if (result) {
            ...
            String jwt = JwtUtil.createJWT(UUID.randomUUID().toString(), admin.getPassword(), null);
            map.put("token", jwt);
           // redisTemplate.opsForValue().set("token", jwt, 3600 * 24);
