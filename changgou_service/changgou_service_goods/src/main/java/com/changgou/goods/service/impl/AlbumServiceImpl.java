...
import com.changgou.goods.dao.AlbumsMapper;
...
public class AlbumServiceImpl implements AlbumService {
    ...
    @Override
    public List<Map> findTemplate(int templateId) {
        List<Map> maps =   albumsMapper.findTemplate(templateId);
        return maps;
    }
    ...
    public List<Album> findList() {
        List<Album> albumList = albumsMapper.findList();
        return albumList;
    }
    ...
    public int insertByMap(Map<String, Object> map) {
        ...
        int result = albumsMapper.insertByMap(map);
        return result;
    }

    @Override
    public int deleteAlbum(int id) {
        int result = albumsMapper.deleteAlbum(id);
        return result;
    }

    @Override
    public int updateAlbum(Album album) {
        int result = albumsMapper.updateAlbum(album);
        return result;
    }
